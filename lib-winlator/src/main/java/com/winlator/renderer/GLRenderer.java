...
//        if (xrActivityIsSupported()) xrFrame = XrActivity.getInstance().beginFrame(XrActivity.getImmersive(), XrActivity.getSBS());
...
//        }
    ...
    //todo lyh xrActivity一般未使用，暂不添加 该类其他位置注释
    private boolean xrActivityIsSupported(){
        return false;
//        return XrActivity.isSupported();
    }
}
